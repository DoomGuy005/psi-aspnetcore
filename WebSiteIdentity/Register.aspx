<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebSiteIdentity.Register" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div>
                <asp:Button runat="server" Text="Cadastrar" OnClick="CadastrarClick"/>
            </div>
        </div>
